  ...
  <div class="admin-user-management">
    ...
    <table>
      ...
      <tr v-for="user in tableData.list" :key="user.id" class="user-row" @mouseover="hoveredRow = user.id"
        ...
        <td>
          <el-button size="default" class="action-btn edit-btn" @click="openEditDialog(user)">
            编辑
          </el-button>
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑用户' : '新增用户'" class="user-dialog" width="50%">
      <el-form :model="currentUser" label-width="120px" ref="userForm" :rules="rules" @submit.native.prevent>
        ...
        <el-form-item label="身份证号" prop="idCard">
          <el-input v-model="currentUser.id_card" placeholder="请输入身份证号"/>
        </el-form-item>

        <el-form-item label="电话" prop="phone">
          <el-input v-model="currentUser.phone_number" placeholder="请输入电话"/>
        </el-form-item>
...
const openAddDialog = () => {
  isEdit.value = false;
  currentUser.value = {id: '', name: '', gender: '', age: null, id_card: '', phone_number: '', address: '', time: null};
